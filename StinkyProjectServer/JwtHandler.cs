...
namespace StinkyProjectServer;
    ...
    public class JwtHandler (IConfiguration configuration, UserManager<StinkyUser> userManager)
    {

    public async Task<JwtSecurityToken> GetTokenAsync(StinkyUser user) =>
        new(
    ...
    private async Task<List<Claim>> GetClaimsAsync(StinkyUser user)
    {
